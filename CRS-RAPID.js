...
process.on("unhandledRejection", errorHandler);
 ...
 if (process.argv.length < 7){console.log(`@The_Crusaderss\n node CRS-RAPID.js target time rate thread proxyfile`); process.exit();}
 const headers = {};
...
const tips1 =[
 "MADE BY @THE_CRUSADERSS",
 "Buy Method? @THE_CRUSADERSS",
 "Proxy high -> take down website easily",
];
